...
void DIGIT_DrawLine(u16 x1, u16 y1, u16 x2, u16 y2, u16 color);	//x和y是 抽象点
void DIGIT_DrawSeg(u8 seg);
void DIGIT_DrawDigit(u8 num);  //参数范围范围0-9
void DIGIT_DrawStartTime(u8 hour, u8 minute, u8 second);
...
void MY_LCD_ShowChar(u16 x,u16 y,u8 num,u16 fc,u16 bc,u8 sizey,u8 mode);
...
#define SKYBLUE      	 0X1C1B	//蓝色#1E82DB
